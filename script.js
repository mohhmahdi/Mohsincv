...
window.addEventListener('scroll', () => {
    ...
    if (window.scrollY < homeRect.top) {
    ...
    } else if (window.scrollY >= homeRect.bottom) {
        ...
        let percentOpen = Math.min(distanceFromFooter / 700, 1); // Adjust divisor to control speed of closing
