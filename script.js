...
window.addEventListener('scroll', function() {
    ...
    if (homeRect.bottom > 0 && homeRect.top < windowHeight) {
        ...
        let translateX = 100 * percentClosed;  // Adjust the multiplier to control the extent of movement
        ...
        let translateX = 100 * (1 - percentOpen);  // Adjust the multiplier to control the extent of movement
        pen.style.transform = `translateX(-${translateX}%)`;
        cap.style.transform = `translateX(${translateX}%)`;
    }
});
